...
Make sure you have a valid nextjs project with required version 14.xx (or more) .

### 2. neonDB

Project anjum uses a [neon](https://neon.tech/) instance to store the data. So make sure you have created a database with
 postgres neon.
